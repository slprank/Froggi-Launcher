			...
			overlays: [
				{
					...
					[LiveStatsScene.WaitingForDolphin]: {
						...
						backgroundImage: { src: '', name: '', objectFit: '' },
						backgroundCustomImage: { src: '', name: '', objectFit: '' },
						duration: 250,
						durationBackground: 250,
						layers: [[]],
						opacity: 1,
						transition: Transition.None,
						transitionBackground: Transition.None,
					},
	...
	export function getNewOverlay(newId: number): Overlay {
		return {
			...
			[LiveStatsScene.WaitingForDolphin]: {
				...
				backgroundColor: 'white',
				backgroundImage: { src: undefined, name: undefined, objectFit: undefined },
				backgroundCustomImage: { src: undefined, name: undefined, objectFit: undefined },
				duration: 250,
				durationBackground: 250,
				layers: [[]],
				opacity: 1,
