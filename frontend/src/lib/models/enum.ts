...
export enum CustomElement {
	...
	CurrentPlayerActionCountDashDance = 4251,
	Player1ActionCountJabAirDashDance = 4252,
	Player2ActionCountJabAirDashDance = 4253,
	CurrentPlayerActionCountLedgeGrab = 4254,
	Player1ActionCountJabAirLedgeGrab = 4255,
	Player2ActionCountJabAirLedgeGrab = 4256,
	CurrentPlayerActionCountRoll = 4257,
	Player1ActionCountRoll = 4258,
	Player2ActionCountRoll = 4259,
	CurrentPlayerActionSpotDodge = 4260,
	Player1ActionSpotDodge = 4261,
	Player2ActionSpotDodge = 4262,
	CurrentPlayerActionWaveDash = 4263,
	Player1ActionWaveDash = 4264,
	Player2ActionWaveDash = 4265,
	CurrentPlayerActionWaveLand = 4266,
	Player1ActionWaveLand = 4267,
	Player2ActionWaveLand = 4268,

	CurrentPlayerActionGrabTotal = 4269,
	Player1ActionGrabTotal = 4270,
	Player2ActionGrabTotal = 4271,
	CurrentPlayerActionGrabSuccess = 4272,
	Player1ActionGrabSuccess = 4273,
	Player2ActionGrabSuccess = 4274,
	CurrentPlayerActionGrabFail = 4275,
	Player1ActionGrabFail = 4276,
	Player2ActionGrabFail = 4277,
	CurrentPlayerActionGrabSuccessPercent = 4278,
	Player1ActionGrabSuccessPercent = 4279,
	Player2ActionGrabSuccessPercent = 4280,
	CurrentPlayerActionGrabFailPercent = 4281,
	Player1ActionGrabFailPercent = 4282,
	Player2ActionGrabFailPercent = 4283,

	CurrentPlayerActionGroundTechTotal = 4284,
	Player1ActionGroundTechTotal = 4285,
	Player2ActionGroundTechTotal = 4286,
	CurrentPlayerActionGroundTechIn = 4287,
	Player1ActionGroundTechIn = 4288,
	Player2ActionGroundTechIn = 4289,
	CurrentPlayerActionGroundTechOut = 4290,
	Player1ActionGroundTechOut = 4291,
	Player2ActionGroundTechOut = 4292,
	CurrentPlayerActionGroundTechNeutral = 4293,
	Player1ActionGroundTechNeutral = 4294,
	Player2ActionGroundTechNeutral = 4295,
	CurrentPlayerActionGroundTechFail = 4293,
	Player1ActionGroundTechFail = 4294,
	Player2ActionGroundTechFail = 4295,
	CurrentPlayerActionGroundTechSuccess = 4293,
	Player1ActionGroundTechSuccess = 4294,
	Player2ActionGroundTechSuccess = 4295,

	CurrentPlayerActionLCancelTotal = 4296,
	Player1ActionLCancelTotal = 4297,
	Player2ActionLCancelTotal = 4298,
	CurrentPlayerActionLSuccess = 4299,
	Player1ActionLSuccess = 4300,
	Player2ActionLSuccess = 4301,
	CurrentPlayerActionLFail = 4302,
	Player1ActionLFail = 4303,
	Player2ActionLFail = 4304,
	CurrentPlayerActionLSuccessPercent = 4305,
	Player1ActionLSuccessPercent = 4306,
	Player2ActionLSuccessPercent = 4307,
	CurrentPlayerActionLPercent = 4308,
	Player1ActionLPercent = 4309,
	Player2ActionLPercent = 4310,

	CurrentPlayerActionThrowTotal = 4311,
	Player1ActionThrowTotal = 4312,
	Player2ActionThrowTotal = 4313,
	CurrentPlayerActionThrowUp = 4314,
	Player1ActionThrowUp = 4315,
	Player2ActionThrowUp = 4316,
	CurrentPlayerActionThrowForward = 4317,
	Player1ActionThrowForward = 4318,
	Player2ActionThrowForward = 4319,
	CurrentPlayerActionThrowBack = 4320,
	Player1ActionThrowBack = 4321,
	Player2ActionThrowBack = 4322,
	CurrentPlayerActionThrowDown = 4323,
	Player1ActionThrowDown = 4324,
	Player2ActionThrowDown = 4325,

	CurrentPlayerActionWallTechTotal = 4326,
	Player1ActionWallTechTotal = 4327,
	Player2ActionWallTechTotal = 4328,
	CurrentPlayerActionWallTechSuccess = 4329,
	Player1ActionWallTechSuccess = 4330,
	Player2ActionWallTechSuccess = 4331,
	CurrentPlayerActionWallTechFail = 4332,
	Player1ActionWallTechFail = 4333,
	Player2ActionWallTechFail = 4334,
	CurrentPlayerActionWallTechSuccessPercent = 4335,
	Player1ActionWallTechSuccessPercent = 4336,
	Player2ActionWallTechSuccessPercent = 4337,
	CurrentPlayerActionWallTechFailPercent = 4338,
	Player1ActionWallTechFailPercent = 4339,
	Player2ActionWallTechFailPercent = 4340,
