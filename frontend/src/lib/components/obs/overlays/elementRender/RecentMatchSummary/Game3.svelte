...
{#if dataItem?.elementId === CustomElement.CurrentSetGame3Player2CharacterIcon}
	...
	/>
{/if}
{#if dataItem?.elementId === CustomElement.CurrentSetGame3Player1CharacterRenderLeft}
	<CharacterRender
		{style}
		{dataItem}
		characterId={game?.settings?.players.at($currentPlayers?.at(0)?.playerIndex ?? 0)
	...
	/>
{/if}
{#if dataItem?.elementId === CustomElement.CurrentSetGame3Player1CharacterRenderRight}
	<CharacterRender
		{style}
		{dataItem}
		characterId={game?.settings?.players.at($currentPlayers?.at(0)?.playerIndex ?? 0)
	...
	/>
{/if}
{#if dataItem?.elementId === CustomElement.CurrentSetGame3Player2CharacterRenderLeft}
	<CharacterRender
		{style}
		{dataItem}
		characterId={game?.settings?.players.at($currentPlayers?.at(1)?.playerIndex ?? 1)
	...
	/>
{/if}
{#if dataItem?.elementId === CustomElement.CurrentSetGame3Player2CharacterRenderRight}
	<CharacterRender
		{style}
		{dataItem}
		characterId={game?.settings?.players.at($currentPlayers?.at(1)?.playerIndex ?? 1)
