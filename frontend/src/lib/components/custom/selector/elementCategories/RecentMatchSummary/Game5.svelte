...
<div class="flex flex-col gap-2">
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Stage}
		on:select={select}
	>
		Recent Game Stage
	</SelectOption>
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player1Score}
		on:select={select}
	>
		Player 1 Score
	</SelectOption>
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player2Score}
		on:select={select}
	>
		Player 2 Score
	</SelectOption>
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player1CharacterIcon}
		on:select={select}
	>
	...
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player2CharacterIcon}
		on:select={select}
	>
	...
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player1StocksRemaining}
		on:select={select}
	>
	...
	<SelectOption
		...
		value={CustomElement.CurrentSetGame5Player2StocksRemaining}
		on:select={select}
	>
