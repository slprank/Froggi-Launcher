<script lang="ts">
	...
	import { currentPlayer, currentPlayers, postGame, postMatch } from '$lib/utils/store.svelte';
	...
	$: currentPlayerAttackCount = $postMatch?.actionCounts?.[currentPlayerIndex ?? 0]?.attackCount;
</script>
