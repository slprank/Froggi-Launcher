...
>
	<TextFitMulti
		class={`grid justify-items-start col-span-4 pl-4 md:pl-0 text-white text-shadow ${
	...
	<TextFitMulti
		class={`grid justify-items-end col-span-4 pr-4 md:pr-0 text-white text-shadow ${
			$isMobile ? 'text-[2rem] sm:text-[2.5rem]' : 'text-4xl md:text-5xl lg:md:text-6xl'
		}`}
	>
		{'Ginger'}
